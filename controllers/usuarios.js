...
module.exports = function(app){
	...
	console.log("### controllers/usuarios.js ==> #002 Usuario: " + Usuario);
	console.log("### controllers/usuarios.js ==> #002 Usuario: " + Usuario);
	console.log("### controllers/usuarios.js ==> #002 Usuario: " + Usuario);
	...
	var UsuarioController = {
		index: function(req, res) {
			...
			console.log("### AAAAAAAAAAAAAAAAAAAAAAAAAAAAA " + app.mountpath);
			console.log("### AAAAAAAAAAAAAAAAAAAAAAAAAAAAA " + app.mountpath);
			console.log("### AAAAAAAAAAAAAAAAAAAAAAAAAAAAA " + app.mountpath);
			console.log("### AAAAAAAAAAAAAAAAAAAAAAAAAAAAA " + app.mountpath);
		...
		zzzcrudmongodb: function(req, res) {
			console.log("### controllers/usuarios.js ==> #003 index " + app.mountpath);
			console.log("### ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ " + app.mountpath);
			console.log("### ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ " + app.mountpath);
			console.log("### ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ " + app.mountpath);
			console.log("### ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ " + app.mountpath);
/*		    res.render('home/ZZZCRUDMongoDb'); */
			console.log("### controllers/usuarios.js ==> #003 index " + app.mountpath);
			console.log("### AAAAAAAAAAAAAAAAAAAAAAAAA controllers/usuarios.js ==> #003 index " + app.mountpath);
			console.log("### AAAAAAAAAAAAAAAAAAAAAAAAA controllers/usuarios.js ==> #003 index " + app.mountpath);
			console.log("### AAAAAAAAAAAAAAAAAAAAAAAAA controllers/usuarios.js ==> #003 index " + app.mountpath);
			console.log("### AAAAAAAAAAAAAAAAAAAAAAAAA controllers/usuarios.js ==> #003 index " + app.mountpath);
			console.log("### AAAAAAAAAAAAAAAAAAAAAAAAA controllers/usuarios.js ==> #003 index " + app.mountpath);
